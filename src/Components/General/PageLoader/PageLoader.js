...
export const PageLoader = () => {
  ...
  React.useEffect(() => {
    const startAnimations = async () => {
      ...
      await carAnimation.start({ x: 'calc(100% - 102px)' });
    };

    startAnimations();
  }, [containerAnimation, carAnimation]);
  ...
  return (
    <div className="page-loader">
      <motion.svg
        ...
        viewBox="0 0 102 40"
      >
        <g transform="translate(2 1)" stroke="#002742" fill="red" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
          <motion.path
            className="car__body"
